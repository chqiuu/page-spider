...
async function saveData(data) {
  ...
  if (useMySQL) {
    // 使用MySQL
    try {
      return await MySQLStorage.saveData(data, '/api/tender/save');
    } catch (error) {
...
async function getAllData() {
  ...
  if (useMySQL) {
    try {
      return await MySQLStorage.getAllData('/api/tender/all');
    } catch (error) {
...
async function getDataCount() {
  ...
  if (useMySQL) {
    try {
      return await MySQLStorage.getDataCount('/api/tender/count');
    } catch (error) {
